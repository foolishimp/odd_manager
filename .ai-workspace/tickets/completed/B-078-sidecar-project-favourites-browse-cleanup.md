...
## Review State At 2026-05-30

- Operator visual review was open before the prime-set acceptance below.

## Prime-Set Acceptance 2026-07-11

The implementation and proof recorded above are accepted. T-034 then moved
cross-Project discovery, registration, and activation into Build Portfolio and
removed the Sidecar Projects provider entirely. Sidecar Browse remains
Project-local, while ADR-002 governs the current `T/C/S/B` navigator grammar.
This ticket is retained as history and must not be used to restore the removed
Project Browser.
